			...
			<section class="section-3a p-4">
				...
				<div className="mx-auto my-3 " style={{ color: "white", textAlign: "center" }}>
					...
					<div class="row">
						...
						<CoordinatorCard name="Divyaraj Thakaria" designation="Coordinator" year="4th Year-Div1" ImgSrc={Divyaraj}/>
						<CoordinatorCard name="Nency Badiyani" designation="Coordinator" year="4th Year-Div2" ImgSrc={Nency}/>
