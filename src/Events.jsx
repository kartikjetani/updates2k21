        ...
        <>
            <div id="non-tech">
                <div class="mx-auto" style={{ color: "white", textAlign: "center" }}>
                    <p  style={{ margin: "12px 0px 4px 12px",fontSize:"2rem"}}  className="title">Non-Technical Events :</p>
                </div>
                ...
                <div id="tech">
                    <div className="mx-auto" style={{ color: "white", textAlign: "center" }}>
                        <p  style={{ margin: "12px 0px 4px 12px",fontSize:"2rem"}}  className="title">Technical Events :</p>
                    </div>
                    <div className="row mx-auto">
