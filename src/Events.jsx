        ...
        <>
            <div id="non-tech">
                <div class="mx-auto" style={{ color: "white", textAlign: "center" }}>
                    <p style={{ margin: "20px 0px 20px 12px",fontSize:"40px"}} className="title">Non-Technical Events</p>
                </div>
                ...
                <div id="tech">
                    <div className="mx-auto" style={{ color: "white", textAlign: "center" }}>
                        <p style={{ margin: "20px 0px 20px 12px",fontSize:"40px" }} className="title">Technical Events</p>
                    </div>
                    <div className="row mx-auto">
